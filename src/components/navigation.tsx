  ...
  return (
    <div className="flex items-center justify-center gap-12">
      ...
      <button
        ...
        className="flex flex-row gap-2 p-2 h-fit text-white cursor-pointer hover:outline-2 focus-visible:outline-2 outline-offset-1 outline-zinc-100/20 focus-visible:outline-white rounded-lg"
      >
        <Menu />
        Menu
      </button>
